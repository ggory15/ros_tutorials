...
class MoveGroupPythonInterfaceTutorial(object):
    ...
    def __init__(self):
        ...
        ## arm joints in the ur5 robot, so we set the group's name to "ur5_arm".
    ...
    def go_to_joint_state(self):
        ...
        ## ^^^^^^^^^^^^^^^^^^^^^^^^
        ## The ur5's zero configuration is at a `singularity <https://www.quora.com/Robotics-What-is-meant-by-kinematic-singularity>`_, so the first
    ...
    def add_box(self, timeout=4):
        ...
        box_pose.pose.position.z = 0.11  # above the ur5_hand frame
        box_name = "box"
    ...
    def attach_box(self, timeout=4):
        ...
        ## planning scene to ignore collisions between those links and the box. For the ur5
